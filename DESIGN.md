...
:root {
  /* Surfaces */
  --bg: oklch(1 0 0); /* pure white — brand warmth lives in primary, not bg */
  --surface: oklch(
    0.975 0.006 270
  ); /* bg + faintest violet tint — cards, panels */
  --border: oklch(0.918 0.01 270); /* soft violet-tinted border */

  /* Text */
  --ink: oklch(
    0.175 0.028 270
  ); /* near-black with violet undertone — 14:1 on white (AAA) */
  --muted: oklch(
    0.42 0.015 270
  ); /* secondary text — ≥5.5:1 on white (AAA large, AA body) */

  /* Brand */
  --primary: oklch(
    0.49 0.15 270
  ); /* grounded violet — buttons, links, focus rings */
  --primary-fg: oklch(1 0 0); /* white text on primary fill */
  --accent: oklch(
    0.54 0.145 350
  ); /* dusty rose — badges, status, CTAs, highlights */
  --accent-fg: oklch(1 0 0); /* white text on accent fill */

  /* Semantic */
  --success: oklch(0.52 0.13 162); /* teal-green — positive health metrics */
  --warning: oklch(0.66 0.14 65); /* warm amber — caution / elevated readings */
  --destructive: oklch(
    0.56 0.19 22
  ); /* red-orange — errors, destructive actions */
  --destructive-fg: oklch(1 0 0);

  /* Charts (ordered by emotional valence: calm → active) */
  --chart-1: oklch(0.49 0.15 270); /* primary violet */
  --chart-2: oklch(0.54 0.145 350); /* rose accent */
  --chart-3: oklch(0.52 0.13 162); /* teal */
  --chart-4: oklch(0.66 0.14 65); /* amber */
  --chart-5: oklch(0.6 0.12 220); /* soft blue */
}
```
...
```css
.dark {
  --bg: oklch(0.08 0 0); /* near-black — no hue tint */
  --surface: oklch(0.13 0.01 270); /* slightly violet-tinted panels */
  --border: oklch(0.22 0.015 270);

  --ink: oklch(0.96 0 0); /* near-white */
  --muted: oklch(0.65 0.01 270); /* ≥4.5:1 on dark bg */

  --primary: oklch(
    0.68 0.14 270
  ); /* lighter in dark — still grounded, not neon */
  --primary-fg: oklch(0.08 0 0); /* dark text on light primary */
  --accent: oklch(0.72 0.12 350);
  --accent-fg: oklch(0.08 0 0);

  --success: oklch(0.68 0.12 162);
  --warning: oklch(0.76 0.13 65);
  --destructive: oklch(0.64 0.17 22);

  --chart-1: oklch(0.68 0.14 270);
  --chart-2: oklch(0.72 0.12 350);
  --chart-3: oklch(0.68 0.12 162);
  --chart-4: oklch(0.76 0.13 65);
  --chart-5: oklch(0.7 0.11 220);
}
```
...
--text-base: clamp(1rem, 0.95vw + 0.7rem, 1.063rem);
--text-lg: clamp(1.125rem, 1.1vw + 0.8rem, 1.25rem);
--text-xl: clamp(1.25rem, 1.3vw + 0.9rem, 1.5rem);
--text-2xl: clamp(1.5rem, 1.7vw + 1rem, 2rem);
--text-3xl: clamp(1.875rem, 2.2vw + 1.2rem, 2.5rem);
--text-4xl: clamp(2.25rem, 3vw + 1.4rem, 3.5rem);
...
export const motionSlow = { duration: 0.4, ease: [0.16, 1, 0.3, 1] };
